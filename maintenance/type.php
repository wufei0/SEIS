                                         ...
                                         <form class="form-horizontal"  onSubmit="return SearchType();">
                                            <div class="input-group input-group-sm">
                                              ...
                                              <span class="input-group-btn">
                                                <button id="search_type" class="btn btn-default" type="submit">
...
?>
 <script language="JavaScript" type="text/javascript">
     var form_name='TYPE';//holder for privilege checking    
    var pk_type;
    //<!---------------Save Ajax--------------->
    function AddType()
    {
        ...
        jQuery.ajax({
               ...
               data:{form:form_name,module:module_name,type_name:$("#type_name").val(),desc_name:$("#description_name").val()},
                beforeSend: function()
               {
                    $.blockUI();
